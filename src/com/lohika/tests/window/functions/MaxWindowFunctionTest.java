...
public class MaxWindowFunctionTest {

    private static String path = System.getProperty("user.dir") + "/generatedSQLs/WindowFunctions/MAX/";
    ...
    private static String addTestCase(String tableName, MaxMinOptions mo, OrderBy ob, String message, PartitionByType partition) {
        ...
        result.append("SELECT column_1, MAX(");
    ...
    public static String getRowsFrameClauses(String tableName) {
        ...
        String pattern = "SELECT column_1, MAX(column_1) OVER(%s) FROM " + tableName + ";\n";
    ...
    public static String getWindowClause(String tableName) {
        return "-- ************** WINDOW CLAUSE TESTS **************\n" +
                ...
                "SELECT column_1, column_2, MAX(column_1) OVER  w FROM " + tableName + " WINDOW w AS (ORDER BY column_2);\n\n";
    ...
    public static void createTests() {
        for (DataType type : typesToTest) {
            ...
            String tableName = "MAX_" + type.toString() + "_table";
