...
public class DenseRankWindowFunctionTest {

    private static String path = System.getProperty("user.dir") + "/generatedSQLs/WindowFunctions/DENSE_RANK/";
    ...
    private static String addTestCase(String tableName, OrderBy ob, String message, PartitionByType partition) {
        ...
        result.append("SELECT column_1, DENSE_RANK() OVER (");
        if (partition != null)
    ...
    public static String getRowsFrameClauses(String tableName) {
        ...
        String pattern = "SELECT column_1, DENSE_RANK(column_1) OVER(%s) FROM " + tableName + ";\n";
    ...
    public static String getWindowClause(String tableName) {
        return "-- ************** WINDOW CLAUSE TESTS **************\n" +
                ...
                "SELECT column_1, column_2, DENSE_RANK(column_1) OVER  w FROM " + tableName + " WINDOW w AS (ORDER BY column_2);\n\n";
