...
public class CharacterTypesComparisonTest {
    ...
    static {
        ...
        numTypesMapNegative.put(DataType.INTEGER, new DataType[]{DataType.SMALLINT, DataType.BOOLEAN, DataType.CHAR, DataType.VARCHAR, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.VARCHAR_FOR_BIT_DATA, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.CLOB, DataType.BLOB, DataType.DATE, DataType.TIME, DataType.TIMESTAMP});
        numTypesMapNegative.put(DataType.BIGINT, new DataType[]{DataType.SMALLINT, DataType.BOOLEAN, DataType.CHAR, DataType.VARCHAR, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.VARCHAR_FOR_BIT_DATA, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.CLOB, DataType.BLOB, DataType.DATE, DataType.TIME, DataType.TIMESTAMP});
        numTypesMapNegative.put(DataType.DECIMAL, new DataType[]{DataType.SMALLINT, DataType.BOOLEAN, DataType.CHAR, DataType.VARCHAR, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.VARCHAR_FOR_BIT_DATA, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.CLOB, DataType.BLOB, DataType.DATE, DataType.TIME, DataType.TIMESTAMP});
        numTypesMapNegative.put(DataType.NUMERIC, new DataType[]{DataType.SMALLINT, DataType.BOOLEAN, DataType.CHAR, DataType.VARCHAR, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.VARCHAR_FOR_BIT_DATA, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.CLOB, DataType.BLOB, DataType.DATE, DataType.TIME, DataType.TIMESTAMP});
        numTypesMapNegative.put(DataType.REAL, new DataType[]{DataType.SMALLINT, DataType.BOOLEAN, DataType.CHAR, DataType.VARCHAR, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.VARCHAR_FOR_BIT_DATA, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.CLOB, DataType.BLOB, DataType.DATE, DataType.TIME, DataType.TIMESTAMP});
        numTypesMapNegative.put(DataType.DOUBLE, new DataType[]{DataType.SMALLINT, DataType.BOOLEAN, DataType.CHAR, DataType.VARCHAR, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.VARCHAR_FOR_BIT_DATA, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.CLOB, DataType.BLOB, DataType.DATE, DataType.TIME, DataType.TIMESTAMP});
        numTypesMapNegative.put(DataType.FLOAT, new DataType[]{DataType.SMALLINT, DataType.BOOLEAN, DataType.CHAR, DataType.VARCHAR, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.VARCHAR_FOR_BIT_DATA, DataType.LONG_VARCHAR_FOR_BIT_DATA, DataType.CLOB, DataType.BLOB, DataType.DATE, DataType.TIME, DataType.TIMESTAMP});
    }
